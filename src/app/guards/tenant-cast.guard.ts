...
export class TenantCastGuard implements CanActivate {
  constructor(private tenantCastAuthService: TenantCastAuthService, private router: Router) {
  }
    ...
    return this.tenantCastAuthService.loggIn$()
      .pipe(
        ...
        map(v => {
          ...
          return this.router.createUrlTree([ '/tenant-cast/login' ], {
            queryParams: {
